...
class CompletedWorkout extends Component {
  ...
  deleteCompletedWorkout = () => {
    ...
    if (confirm === true) {
      ...
      APIManager.delete(
        `completedWorkouts/${this.props.completedWorkout.id}`
      ).then(() => {
        this.setState({
          exerciseList: [],
          resultList: [],
    ...
    return (
      <div className="cw-workout-card">
              ...
              <div key={exercise.id} className="cw-exercise-container">
                ...
                <div className="cw-results-container">
                  ...
                  {this.state.resultList[exIndx].performance
                    ...
                    .map((result, indx) => {
                      return (
                        <div className="cw-result-text" key={indx}>
                          {result}
                        </div>
                      );
                    })}
        ...
        <div className="cw-icon-container">
          ...
          <FontAwesomeIcon
            icon={faTimes}
            className="fa-lg cw-x"
            onClick={this.deleteCompletedWorkout}
          />
        </div>
      </div>
    );
